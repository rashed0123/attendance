...
<head>
	...
	<?php 
		$title = "KUE LIGHT - Ultimate Admin Panel Solution";
		echo title($title);
...
<div class="container" id="container">
    <div  id="header">
    	<div id="profile_info">
			...
			<p>Welcome <strong>rzepak</strong>. <?php echo anchor("admin_panel/logout","Log out?");?></p>
			<p>System messages: 3. <a href="#">Read?</a></p>
			<p class="last_login">Last login: 21:03 12.05.2009</p>
		</div>
		<div id="logo"><h1><a href="/">Admin Panel</a></h1></div>
