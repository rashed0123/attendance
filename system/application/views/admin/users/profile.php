...
?>
	...
	<div id="content_main" class="clearfix">
		<div id="tabledata" class="section" style="float: left;width: 69%; margin-top: 0px;" >
			<h2 class="ico_mug">My Current Profile</h2>
				<?php 
					if(!empty($check) && $check == 1) 
					{
						echo anchor("profile/edit_profile","<button>Edit Profile</button>");
					}else{
						echo anchor("profile/view_profile","<button>Profile</button>");
					}
				
				echo anchor("profile/ch_pass","<button>changes password</button>");?>
			<?php
				if(!empty($check) && $check == 1)
				{
					if(!empty($success))
			...
			<?php 
				...
				echo form_open("profile/edit_profile",$att);
			?>
